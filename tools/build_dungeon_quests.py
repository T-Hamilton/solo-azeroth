...
Output: client-addons/SoloDungeonQuests/DungeonQuestsData.lua  (a Lua table the addon reads).
Run any time the world DB changes; it only rewrites the Lua data file.
"""
